...
| union.flytepropeller.image.repository | string | `"cr.flyte.org/flyteorg/flytepropeller"` |  |
| union.flytepropeller.image.tag | string | `"v1.1.98"` |  |
